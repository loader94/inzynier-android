...
public class tab_1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //ArrayAdapter arrayAdapter = new ArrayAdapter<String>(getActivity().getApplicationContext(), R.layout.showelement, R.id.tvNazwa, listanazw);
        lista.setAdapter(m_adapter);
        final EditText search = (EditText) view.findViewById(R.id.etwyszukaj);
        Button bwyszukaj = (Button) view.findViewById(R.id.bwyszukaj);
        bwyszukaj.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = "http://" + LoginActivity.ip + ":8080/inz/request_android.php?category=laptopy";
